...
class model_infer:
    ...
    def run_benchmark(self):
        ...
        with tf.compat.v1.Session(graph=self.infer_graph,
            ...
            return total_batches * self.args.batch_size / ttime
    ...
    def inference(self, input_graph=None):
        ...
        with tf.compat.v1.Session(graph=self.infer_graph,
            ...
            while True:
                ...
                if iter * self.args.batch_size >= COCO_NUM_VAL_IMAGES:
                    ...
                    speed = self.args.batch_size*iter/total_time
                    return res['DetectionBoxes_Precision/mAP'], speed
...
if __name__ == "__main__":
    ...
    if args.tune:
        ...
        if not q_model:
            ...
            exit(0)
        acc, speed = infer.inference(q_model)
        bs = args.batch_size
        print("q_model accuracy batch_size: %d" % bs)
        print("q_model accuracy: %.3f " % acc)
