...
for model in model_list:
    ...
    commond = "python run.py -i 100 --precision lpot -b 1 --arch pytorch-unet"
    ...
    # commond = "python run.py -i 100 --precision int8 -b 1"
    # subprocess.check_output(commond, shell=True)
    ...
    # commond = "python run.py -i 100 -b 1"
    # for n in range(process_num):
    #     head = "numactl --localalloc --physcpubind {},{},{},{}  timeout 3600 ".format(i, i+1, i+2, i+3)
