...
# torch.save(traced, "traced_ebgan-discriminator.pth")
# print('saved trace')
# try:
...
# q_model.save("jit_ebgan-discriminator.pth")
# print('saved jit')

# from torch.fx import symbolic_trace
# traced = symbolic_trace(generator)
# torch.save(traced, "traced_ebgan-generator.pth")
# print('saved trace')
# try:
...
#     except:
#         logger.info("This model can't convert to Script model")
# q_model.save("jit_ebgan-generator.pth")
# print('saved jit')
# print(0/0)
