...
for model in model_list:
    print(model)
    commond = "python dcgan.py --precision lpot --batch_size 1 --inference --num-iterations 100"
    ...
    # commond = "python dcgan.py --precision int8 --batch_size 1 --inference --num-iterations 100"
    # subprocess.check_output(commond, shell=True)
    ...
    commond = "python dcgan.py --batch_size 1 --inference --num-iterations 100"
    for n in range(process_num):
        head = "numactl --localalloc --physcpubind {},{},{},{}  timeout 3600 ".format(i, i+1, i+2, i+3)
