...
for model in model_list:
    ...
    commond = "python began.py --precision lpot --batch_size 1 --inference --num-iterations 100"
    ...
    commond = "python began.py --precision int8 --batch_size 1 --inference --num-iterations 100"
    ...
    commond = "python began.py --batch_size 1 --inference --num-iterations 100"
    for n in range(process_num):
        head = "numactl --localalloc --physcpubind {},{},{},{}  timeout 3600 ".format(i, i+1, i+2, i+3)
