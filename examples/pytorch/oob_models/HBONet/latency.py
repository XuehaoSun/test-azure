...
'''
model_list = ['hbonet0.25', 'hbonet0.5', 'hbonet1']
widthh_list = [0.25, 0.5, 1]
...
for i in range(len(model_list)):
    ...
    commond = "python imagenet.py --dummy -b 1 -a hbonet -e --max_iters 100 --precision lpot --width-mult {}".format(widthh_list[i])
    ...
    # commond = " python imagenet.py --dummy -b 1 -a hbonet -e --max_iters 100 --weight pretrained/hbonet_1_0.pth --width-mult 1"
    # for n in range(process_num):
    #     head = "numactl --localalloc --physcpubind {},{},{},{}  timeout 3600 ".format(i, i+1, i+2, i+3)
