...
'''
model_list = ['se_resnet50', 'dpn68', 'se_resnext50_32x4d', 'inceptionresnetv2', 'vggm']
...
for model in model_list:
    ...
    commond = "python -u examples/imagenet_eval.py -e --pretrained None -j 1 -b 1 -i 100 -a {} --dummy --precision lpot".format(model)
    ...
    # commond = "python -u examples/imagenet_eval.py -e --pretrained None -j 1 -b 1 -i 100 -a se_resnet50 --dummy --precision int8"
    # for n in range(process_num):
    #     head = "numactl --localalloc --physcpubind {},{},{},{}  timeout 3600 ".format(i, i+1, i+2, i+3)
