...
run_cmd=" inferencer --config=${ir_path}/conf.yaml --weight=${ir_path}/model.bin -w=${warm_up_steps} --iterations=${iteration} --batch_size=${bs} --seq_len=${seq_len}"
...
echo "throughput,${model},${seq_len},${cores},${ncores_per_instance},${bs},${precision},${throughput}"
echo "throughput,${model},${seq_len},${cores},${ncores_per_instance},${bs},${precision},${throughput}" >> ${WORKSPACE}/inferencer_summary.log
