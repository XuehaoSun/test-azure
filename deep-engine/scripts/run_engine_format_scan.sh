...
run_cpplint() {
    ...
    cpplint --exclude=./engine/executor/include/kernels/xbyak --exclude=./engine/executor/include/thread_pool.hpp --recursive --quiet --linelength=120 ./engine/ 2>&1| tee ${log_path}
