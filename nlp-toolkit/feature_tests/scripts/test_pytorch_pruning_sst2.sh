...
function main {
    ...
    pip list
    python run_glue.py --task_name sst2 --model_name_or_path yoshitomo-matsubara/bert-base-uncased-sst2 --per_device_train_batch_size 64 --per_device_eval_batch_size 64 --do_train --do_eval --pad_to_max_length --num_train_epochs 5 --output_dir saved_results 2>&1 | tee ${WORKSPACE}/pytorch_pruning_sst2.log
